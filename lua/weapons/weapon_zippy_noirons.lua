...
SWEP.PrintName = "Pistol (No Irons)" -- The name of the SWEP displayed in the spawn menu.
...
SWEP.IronSights = {
    Enable = false, -- Set to false to disable ironsights and use a secondary attack instead
